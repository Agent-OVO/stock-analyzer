...
class Config:
    ...
    news_provider: str = "auto"  # 新闻服务提供者：auto/news_aggregator/tavily/serpapi/bocha/brave
    news_aggregator_skill_path: str = "./skills/news-aggregator-skill"  # News Aggregator Skill 路径
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        return cls(
            ...
            news_aggregator_skill_path=os.getenv('NEWS_AGGREGATOR_SKILL_PATH', './skills/news-aggregator-skill'),
